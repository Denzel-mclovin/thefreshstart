<template>
  ...
  >
          ...
          <ul class="flex flex-col pl-0 mb-0">
            <li class="mt-0.5 w-full">
              <NuxtLink to="/admin/">
                <div
                  ...
                  :class="{
                    'text-white bg-[var(--dark-green)]': activePage === 'admin',
                  }"
                >
                  <div
            ...
            <li class="mt-0.5 w-full">
              <NuxtLink to="/admin/leads">
                <div
                  class="py-[0.675rem] text-sm ease-nav-brand my-0 mx-0 flex items-center whitespace-nowrap px-2 transition-colors rounded-lg font-semibold text-slate-700"
                  @click="closeSidebar(), (activePage = 'admin-leads')"
                  :class="{
                    'text-white bg-[var(--dark-green)]':
                      activePage === 'admin-leads',
                  }"
                >
                  <div
            ...
            <li class="mt-0.5 w-full">
              ...
              <NuxtLink to="/admin/utm-links">
                <div
                  class="py-[0.675rem] text-sm ease-nav-brand my-0 mx-0 flex items-center whitespace-nowrap px-2 transition-colors rounded-lg font-semibold text-slate-700"
                  @click="
                    closeSidebar(), (activePage = 'admin-utm-links')
                  "
                  :class="{
                    'text-white bg-[var(--dark-green)]':
                      activePage === 'admin-utm-links',
                  }"
                >
                  <div
                    class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-1.5"
                  >
                    <img src="@/public/img/icons/link-icon.png" alt="option" />
                  </div>
                  <span
                    class="ml-1 duration-300 opacity-100 pointer-events-none ease"
                  >
    ...
    <main
      class="relative h-full transition-all duration-200 ease-in-out xl:ml-72 rounded-xl min-h-[100vh]"
    >
      <slot />
